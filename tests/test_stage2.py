...
def test_clean_srt_local_fallback(tmp_dir):
    srt_text = """1
00:00:01,000 --> 00:00:03,000
[spk1] Hello world
...
"""
    ...
    cleaned = srt_cleaning.clean_srt(input_srt, output_srt, use_llm=False)
    assert "spk2" not in cleaned
    assert "啊啊啊" not in cleaned
